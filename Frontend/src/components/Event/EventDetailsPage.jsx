    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="mb-8">
        <div className="flex justify-between items-center mb-4">
          ...
          {eventStatus === 'current' && (
            <span className="px-3 py-1 text-sm font-semibold rounded-full bg-yellow-100 text-white-800">
              Happening Now
            </span>
          )}
          {eventStatus === 'past' && (
            ...
            {registrationStatus.loading ? (
              ...
              <>
                {registrationStatus.isRegistered ? (
                  <div className="bg-yellow-50 border border-white-200 rounded-md p-4 mb-4">
                    <div className="flex">
                      ...
                      <div>
                        <p className="font-medium text-yellow-800">You&apos;re registered!</p>
